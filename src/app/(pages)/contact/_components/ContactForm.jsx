  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const templateParams = {
        ...
        describe: formData.describe || 'Not selected',
        message: formData.comment || 'No additional details',
      }

      await emailjs.send(
        process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID || 'service_4d2csi9',
        process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID || 'template_jjqhbp3',
        templateParams,
        process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY || 'GgLuy-8eT_-7fAR6B'
      )
        ...
        <div className="w-full max-w-2xl">
          <div className="px-2 lg:px-0 py-8 lg:py-0">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              {/* ... your entire form JSX remains EXACTLY the same ... */}
